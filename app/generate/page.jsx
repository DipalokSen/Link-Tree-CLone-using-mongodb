...
const Generate = () => {
  ...
  const submitLinks=async (handle) => {
...
const result=await fetch("http://localhost:3000/api/add", requestOptions)
        ...
        <div className='flex flex-col gap-5 my-8'>
          ...
          <div className="item">
            ...
            <div className='mx-4 flex flex-col'>
              ...
              <button onClick={()=>{submitLinks()}} className='disabled:bg-slate-500 p-5 py-2 mx-2 w-fit my-5 bg-slate-900 text-white font-bold rounded-3xl'>Create your BitTree</button>
            </div>
          </div>
        </div>
      </div>
